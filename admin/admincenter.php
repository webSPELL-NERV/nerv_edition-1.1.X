...
<head>
	...
	<meta name="description" content="Clanpage using webSPELL 4.2.5 - NERV EDITION CMS" />
	<meta name="author" content="webspell.org" />
	<meta name="keywords" content="webspell, webspell4, clan, cms, webspellnerv" />
	<meta name="copyright" content="Copyright &copy; 2005 - 2011 by webspell.org" />
	<meta name="generator" content="webSPELL" />
	<title><?php echo $myclanname ?> - webSPELL NERV AdminCenter</title>
	<!--[if IE]>
	<style type="text/css">
	.td1 {  height: 18px; }
	.td2 {  height: 18px; }
	...
	<script src="../js/jquery-2.2.1.min.js" language="JavaScript" type="text/JavaScript"></script>
	<script src="../bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="../js/background-blur.js" type="text/javascript"></script>
	<link href="../bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
	<script src="../js/_nerv-core.js"></script>
...
<table border="0" cellpadding="0" cellspacing="0" width="1000" align="center">
  <tr>
   ...
   <div id="links">
    <ul>
      <li><a href="../index.php" target="_blank" class="link1"></a></li>
  ...
  <script>
   ...
   <div id="menu">
    ...
    <ul>
	  <li class="nerv-menu-element"><a href="../"><b>Zurück zur Hauptseite</b></a></li>
    ...
    <h2>&not; webSPELL NERV</h2> 
    <ul class="nerv-menu">
      <?php  if(ispageadmin($userID)) { ?>
		<li><a href="admincenter.php?site=nervsettings">Einstellungen</a></li>
		<li><a href="admincenter.php?site=plugins">Plugins</a></li>
		<li><a href="admincenter.php?site=navigations">Navigationen</a></li>
		<li><a href="admincenter.php?site=widgets">Widgets</a></li>
		<li><a href="admincenter.php?site=backups">System backups</a></li>
	  <?php } ?>
    </ul>
	<?php } ?>
	
	<?php if(ispageadmin($userID)) { ?>
    <h2>&not; Custom Plugins</h2> 
    <ul class="nerv-custom">
      <?php  if(ispageadmin($userID)) { ?>
		<?php $_plugins->getAdminMenu();?>
	  <?php } ?>
    </ul>
	<?php } ?>
   ...
   <div class="pad" style="position: relative;min-height: 800px;">
   <div id="result" style="display: none"></div>
		<div id="loading-ajax" style="text-align: center;padding-top: 100px;left: 0px;opacity: .9;display: none;position: absolute; top: 0px; width: 100%; height: 100%; background-color: white;">
			<img src="../images/icons/ajax-loader.gif" /><br><br>
			<b>Performing action, please wait.</b>
		</div>
...
<center><br />&copy; 2005 - 2011 <a href="http://www.webspell.org" target="_blank" class="white"><b>webSPELL.org</b></a> &amp; <a href="http://www.webspell.at" target="_blank" class="white"><b>webSPELL.at</b></a>&nbsp;( <?php echo $version; ?> )<br /><br />
webSPELL - <b>NERV EDITION</b> by <a href="http://kevinwie.de/"  target="_blank" class="white"><b>kevinwie.de</b></a> ( <?php echo $nerv_version; ?> )<br><br>
</center>
</body>
</html>
