...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
  <tr>
    ...
    <td width="85%"><input type="text" name="title" value="<?php echo $title;?>" size="72" /></td>
  </tr>
  <tr>
    <td valign="top"><b><?php echo $_language->module['html_mail']; ?></b></td>
    <td><textarea rows="30" cols="" style="width: 80%;" name="message"><?php echo $message;?></textarea></td>
  </tr>
  <tr>
