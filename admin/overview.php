...
echo $_language->module['hello'].'&nbsp;'.$username.',&nbsp;'.$_language->module['last_login'].'&nbsp;'.$lastlogin.'.';
?>
<br /><br/><br/>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#DDDDDD">
  <tr>
   ...
   <tr>
    <td width="25%" class="td1"><b>webSPELL - NERV Edition</b></td>
    <td width="25%" class="td1"><font color="#008000"><?php echo $nerv_version; ?></font></td>
    <td width="25%" class="td1" colspan="2"></td>
  </tr>
  <tr>
