...
elseif($action=="edit") {
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      ...
      <td><img  style="max-width: 100%; min-width: 100%;" src="../images/news-rubrics/'.$ds['pic'].'" alt="" /></td>
    </tr>
    <tr>
		   <td><b>'.$_language->module['picture_upload'].'</b></td>
       <td><input name="pic" type="file" size="40" /></td>
  ...
  while($ds=mysql_fetch_array($ergebnis)) {
    if($i%2) { $td='td1'; }
      ...
      <td class="'.$td.'" align="center"><img style="max-width: 100%; min-width: 100%;" src="../images/news-rubrics/'.$ds['pic'].'" alt="" /></td>
