...
?>
  ...
  <tr>
   <td id="step" align="center" colspan="2">
    <ol class="breadcrumb" style="margin-bottom: 5px;">
		...
		<li class="active"><b><?php echo $_language->module['step3']; ?></b></li>
  ...
  <tr id="headline">
   <td colspan="2" id="title"><br><b>Checking files</b><br></br></td>
  </tr>
  <tr>
   <td id="content" colspan="2">
   <table class="table table-bordered" border="0" cellpadding="0" cellspacing="0" width="100%">
     <tr align="left" valign="top">
      <td><b>Checking NERV integrity:</b><br>
		<?php nerv_checkintegrity();?>
	  </td>
      <td>
